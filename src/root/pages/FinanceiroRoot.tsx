    ...
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-extrabold text-white flex items-center gap-2">
          <DollarSign size={22} className="text-amber-400" /> Financeiro
        </h1>
        <p className="text-gray-400 text-sm mt-1">Visão consolidada da receita do sistema</p>
      </div>

      {/* KPIs */}
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {kpis.map((k) => (
          <div key={k.label} className="bg-[#0e1425] border border-[#1e2d4a] rounded-2xl p-5">
            ...
            <p className="text-2xl font-extrabold text-white">{loading ? '—' : k.valor}</p>
      ...
      <div className="bg-[#0e1425] border border-[#1e2d4a] rounded-2xl p-6">
        <div className="flex items-center justify-between mb-5">
          <h2 className="font-bold text-white text-sm">Evolução do MRR</h2>
      ...
      <div className="grid lg:grid-cols-3 gap-4">
        ...
        <div className="bg-[#0e1425] border border-[#1e2d4a] rounded-2xl p-5">
          <h2 className="font-bold text-white text-sm mb-4">Por Plano</h2>
        ...
        <div className="bg-[#0e1425] border border-[#1e2d4a] rounded-2xl p-5">
          <h2 className="font-bold text-white text-sm mb-4">Por Método</h2>
          <ResponsiveContainer width="100%" height={160}>
            <BarChart data={DIST_METODO} barSize={28} layout="vertical">
              ...
              <Tooltip contentStyle={{ background: '#141c2e', border: '1px solid #1e2d4a', borderRadius: 12, fontSize: 12 }} />
        ...
        {/* Mensal vs Anual */}
        <div className="bg-[#0e1425] border border-[#1e2d4a] rounded-2xl p-5">
          <h2 className="font-bold text-white text-sm mb-4">Ciclo de Cobrança</h2>
          <ResponsiveContainer width="100%" height={160}>
            <PieChart>
