...
const MOCK_CLIENTES: Assinatura[] = [
  { id: '1', nome: 'João da Silva', email: 'joao@escola.com', nome_escola: 'E.E. José de Alencar', plano: 'profissional', ciclo: 'mensal', metodo_pgto: 'pix', valor_total: 397, status: 'ativo', created_at: '2026-01-15' },
  { id: '2', nome: 'Maria Santos', email: 'maria@boa.com', nome_escola: 'Colégio Boa Vista', plano: 'basico', ciclo: 'anual', metodo_pgto: 'boleto', valor_total: 1970, status: 'ativo', created_at: '2026-02-03' },
  { id: '3', nome: 'Pedro Costa', email: 'pedro@nova.com', nome_escola: 'Instituto Nova Geração', plano: 'enterprise', ciclo: 'anual', metodo_pgto: 'cartao', valor_total: 7970, status: 'pendente', created_at: '2026-04-18' },
  { id: '4', nome: 'Ana Oliveira', email: 'ana@edu.com', nome_escola: 'Escola Municipal Progresso', plano: 'profissional', ciclo: 'mensal', metodo_pgto: 'pix', valor_total: 397, status: 'pendente', created_at: '2026-04-19' },
  { id: '5', nome: 'Carlos Lima', email: 'carlos@colegio.com', nome_escola: 'Colégio São Paulo', plano: 'basico', ciclo: 'mensal', metodo_pgto: 'boleto', valor_total: 197, status: 'cancelado', created_at: '2026-03-10' },
  { id: '6', nome: 'Paula Mendes', email: 'paula@edu.com', nome_escola: 'Centro Educacional Novo Mundo', plano: 'profissional', ciclo: 'anual', metodo_pgto: 'pix', valor_total: 3970, status: 'ativo', created_at: '2026-02-28' },
];
...
export const ClientesRoot = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Filtros */}
      <div className="bg-[#0e1425] border border-[#1e2d4a] rounded-2xl p-4 flex flex-wrap gap-3">
        {/* Busca */}
        <div className="flex-1 min-w-48 relative">
          ...
          <input
            ...
            className="w-full pl-8 pr-4 py-2 bg-[#141c2e] border border-[#1e2d4a] rounded-xl text-sm text-white placeholder-gray-600 focus:outline-none focus:border-amber-400/40 transition-all"
          />
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="bg-[#141c2e] border border-[#1e2d4a] text-gray-300 text-sm rounded-xl px-3 py-2 focus:outline-none focus:border-amber-400/40"
          >
                  ...
                  return (
                    <tr key={c.id} className="hover:bg-white/2 transition-colors group">
                      <td className="px-5 py-4">
                        <p className="font-semibold text-gray-100">{c.nome}</p>
                        <p className="text-xs text-gray-500 mt-0.5">{c.nome_escola}</p>
                      ...
                      <td className="px-5 py-4 capitalize text-gray-400 text-xs">{c.metodo_pgto}</td>
                      <td className="px-5 py-4 text-gray-200 font-medium">
                        R$ {c.valor_total.toLocaleString('pt-BR')}
                        <p className="text-[10px] text-gray-500">/{c.ciclo === 'anual' ? 'ano' : 'mês'}</p>
                      </td>
                      <td className="px-5 py-4">
